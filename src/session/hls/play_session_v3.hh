...
class play_session_v3 : public play_session {
 ...
 protected:
    ...
    static void *on_alloc(void *param, size_t bytes);

    static void on_free(void *param, void *buffer) {}
 ...
 private:
    std::unordered_map<int, ts_stream_info> _ts_streams;
    fragment_ptr _fragment;
    int64_t _next_fragment_id = 0;

    void *_muxer = nullptr;
    uint8_t _buffer[192] = {0};
};

...
// In transport streams, the stream_id may be set to any valid value which
// correctly describes the elementary stream type as defined in Table 2-22. In
...
enum EPES_STREAM_ID
{
    ...
    PES_SID_AUDIO = 0xC0,      // ISO/IEC 13818-3/11172-3/13818-7/14496-3 audio
                               // stream '110x xxxx'
    PES_SID_VIDEO =
        0xE0,  // H.262 | H.264 | H.265 | ISO/IEC
               // 13818-2/11172-2/14496-2/14496-10 video stream '1110 xxxx'
...
typedef int (*pes_packet_handler)(

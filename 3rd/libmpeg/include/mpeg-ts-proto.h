...
enum ETS_PID
{
    ...
    TS_PID_SDT =
        0x11,  // https://en.wikipedia.org/wiki/Service_Description_Table
...
enum EPSI_STREAM_TYPE
{
    ...
    PSI_STREAM_MPEG2 =
        0x02,  // Rec. ITU-T H.262 | ISO/IEC 13818-2 Video or ISO/IEC 11172-2
               // constrained parameter video stream(see Note 2)
    PSI_STREAM_AUDIO_MPEG1 = 0x03,  // ISO/IEC 11172-3 Audio
    PSI_STREAM_MP3 = 0x04,          // ISO/IEC 13818-3 Audio
    PSI_STREAM_PRIVATE_SECTION =
        0x05,  // Rec. ITU-T H.222.0 | ISO/IEC 13818-1 private_sections
    PSI_STREAM_PRIVATE_DATA = 0x06,  // Rec. ITU-T H.222.0 | ISO/IEC 13818-1 PES
    ...
    PSI_STREAM_DSMCC_DATA =
        0x17,  // Metadata carried in ISO/IEC 13818-6 Data Carousel
    PSI_STREAM_DSMCC_OBJECT =
        0x18,  // Metadata carried in ISO/IEC 13818-6 Object Carousel
    PSI_STREAM_DSMCC_SDP = 0x19,  // Metadata carried in ISO/IEC 13818-6
                                  // Synchronized Download Protocol
    PSI_STREAM_MPEG2_IPMP =
        0x1a,  // IPMP stream (defined in ISO/IEC 13818-11, MPEG-2 IPMP)
    PSI_STREAM_H264 = 0x1b,  // H.264
    PSI_STREAM_MPEG4_AAC =
        0x1c,  // ISO/IEC 14496-3 Audio, without using any additional transport
               // syntax, such as DST, ALS and SLS
    PSI_STREAM_MPEG4_TEXT = 0x1d,  // ISO/IEC 14496-17 Text
    PSI_STREAM_AUX_VIDEO =
        0x1e,  // Auxiliary video stream as defined in ISO/IEC 23002-3
    PSI_STREAM_H264_SVC =
        0x1f,  // SVC video sub-bitstream of an AVC video stream conforming to
               // one or more profiles defined in Annex G of Rec. ITU-T H.264 |
               // ISO/IEC 14496-10
    PSI_STREAM_H264_MVC =
        0x20,  // MVC video sub-bitstream of an AVC video stream conforming to
               // one or more profiles defined in Annex H of Rec. ITU-T H.264 |
               // ISO/IEC 14496-10
    PSI_STREAM_JPEG_2000 =
        0x21,  // Video stream conforming to one or more profiles as defined in
               // Rec. ITU-T T.800 | ISO/IEC 15444-1
    PSI_STREAM_MPEG2_3D =
        0x22,  // Additional view Rec. ITU-T H.262 | ISO/IEC 13818-2 video
               // stream for service-compatible stereoscopic 3D services
    PSI_STREAM_MPEG4_3D =
        0x23,  // Additional view Rec. ITU-T H.264 | ISO/IEC 14496-10 video
               // stream conforming to one or more profiles defined in Annex A
               // for service-compatible stereoscopic 3D services
    PSI_STREAM_H265 = 0x24,  // Rec. ITU-T H.265 | ISO/IEC 23008-2 video stream
                             // or an HEVC temporal video sub-bitstream
    PSI_STREAM_H265_subset =
        0x25,  // HEVC temporal video subset of an HEVC video stream conforming
               // to one or more profiles defined in Annex A of Rec. ITU-T H.265
               // | ISO/IEC 23008-2
    PSI_STREAM_H264_MVCD =
        0x26,  // MVCD video sub-bitstream of an AVC video stream conforming to
               // one or more profiles defined in Annex I of Rec. ITU-T H.264 |
               // ISO/IEC 14496-10
    PSI_STREAM_VP8 = 0x9d,
    PSI_STREAM_VP9 = 0x9e,
    PSI_STREAM_AV1 = 0x9f,
...
enum
{
    ...
    MPEG_FLAG_PACKET_LOST =
        0x1000,  // packet(s) lost before the packet(this packet is ok, but
                 // previous packet has missed or corrupted)
    MPEG_FLAG_PACKET_CORRUPT =
        0x2000,  // this packet miss same data(packet lost)

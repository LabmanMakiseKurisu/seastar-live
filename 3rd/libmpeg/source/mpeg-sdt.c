...
// in DVB systems 5.2.3 Service Description Table (SDT) (p27)
...
#define SERVICE_NAME "BILIBILI"
#define SERVICE_VALUE "BVC/Media-Gateway"
...
size_t sdt_read(struct pat_t* pat, const uint8_t* data, size_t bytes) {
    ...
    //    int)data[8],(unsigned int)data[9],(unsigned int)data[10]);

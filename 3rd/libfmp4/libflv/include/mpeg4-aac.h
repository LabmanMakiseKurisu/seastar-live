...
struct mpeg4_aac_t {
    ...
    uint8_t sampling_frequency_index;  // 0-96000, 1-88200, 2-64000, 3-48000,
                                       // 4-44100, 5-32000, 6-24000, 7-22050,
                                       // 8-16000, 9-12000, 10-11025, 11-8000,
                                       // 12-7350, 13/14-reserved, 15-frequency
                                       // is written explictly
    uint8_t channel_configuration;     // 0-AOT, 1-1channel,front-center,
                                       // 2-2channels, front-left/right,
                                       // 3-3channels: front center/left/right,
                                       // 4-4channels: front-center/left/right,
                                       // back-center, 5-5channels: front
                                       // center/left/right, back-left/right,
                                       // 6-6channels: front center/left/right,
    // back left/right LFE-channel, 7-8channels
...
enum mpeg4_aac_object_type
{
    ...
    MPEG4_AAC_SSR,
    MPEG4_AAC_LTP,
    MPEG4_AAC_SBR,  // (used with AAC LC in the "High Efficiency AAC Profile"
                    // (HE-AAC v1))
    MPEG4_AAC_SCALABLE,
    MPEG4_AAC_TWINVQ,
    MPEG4_AAC_CELP,
    ...
    MPEG4_AAC_ALGORITHMIC_SYNTHESIS,  // Algorithmic Synthesis and Audio FX
                                      // object type
    MPEG4_AAC_ER_LC,                  // Error Resilient (ER) AAC Low Complexity (LC) object
                                      // type
    ...
    MPEG4_AAC_ER_AAC_LD,              // Error Resilient (ER) AAC LD object type(used with
                                      // CELP, ER CELP, HVXC, ER HVXC and TTSI in the "Low
                                      // Delay Profile")
    ...
    MPEG4_AAC_PS,                     // PS object type(used with AAC LC and SBR in the "HE-AAC v2
                                      // Profile")
    ...
    MPEG4_AAC_ER_AAC_ELD,        // Error Resilient (ER) AAC ELD object type (uses
                                 // AAC-LD, AAC-ELD and AAC-ELDv2, "Low Delay AAC v2")
    MPEG4_AAC_SMR_SIMPLE,        // SMR Simple object type: MPEG-4 Part 23 standard
                                 // (ISO/IEC 14496-23:2008)
    MPEG4_AAC_SMR_MAIN,          // SMR Main object type
    MPEG4_AAC_USAC_NO_SBR,       // Unified Speech and Audio Coding (no SBR)
    MPEG4_AAC_SAOC,              // Spatial Audio Object Coding: MPEG-D Part 2 standard
...
enum mpeg4_audio_profile
{
    ...
    MPEG4_MAIN_AUDIO_PROFILE,                    // AAC Main, AAC LC, AAC SSR, AAC LTP, AAC
                                                 // Scalable, TwinVQ, CELP, HVXC, TTSI, Main
                                                 // synthesis
    MPEG4_SCALABLE_AUDIO_PROFILE,                // AAC LC, AAC LTP, AAC Scalable, TwinVQ,
                                                 // CELP, HVXC, TTSI
    MPEG4_SPEECH_AUDIO_PROFILE,                  // CELP, HVXC, TTSI
    MPEG4_SYNTHETIC_AUDIO_PRIFILE,               // TTSI, Main synthesis
    MPEG4_HIGH_QUALITY_AUDIO_PROFILE,            // AAC LC, AAC LTP, AAC Scalable, CELP,
                                                 // ER AAC LC, ER AAC LTP, ER AAC
                                                 // Scalable, ER CELP
    MPEG4_LOW_DELAY_AUDIO_PROFILE,               // CELP, HVXC, TTSI, ER AAC LD, ER CELP, ER
                                                 // HVXC
    MPEG4_NATURAL_AUDIO_PRIFILE,                 // AAC Main, AAC LC, AAC SSR, AAC LTP, AAC
                                                 // Scalable, TwinVQ, CELP, HVXC, TTSI, ER AAC
                                                 // LC, ER AAC LTP, ER AAC Scalable, ER TwinVQ,
                                                 // ER BSAC, ER AAC LD, ER CELP, ER HVXC, ER
                                                 // HILN, ER Parametric
    MPEG4_MOBILE_AUDIO_INTERNETWORKING_PROFILE,  // ER AAC LC, ER AAC Scalable,
                                                 // ER TwinVQ, ER BSAC, ER AAC
                                                 // LD

...
struct rtmp_server_handler_t
{
	...
	///pull(server -> client)
	///@return 0-ok, other-error
	int (*onplay)(void* param, const char* app, const char* stream, double start, double duration, uint8_t reset, const char* tcurl);
	...
	///@return 0-ok, other-error
	int (*onpublish)(void* param, const char* app, const char* stream, const char* type, const char* tcurl);
...
int rtmp_server_stop(rtmp_server_t* rtmp);
